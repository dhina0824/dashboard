...
export class LineChart {
  ...
  loadUsersChart() {
    this.lineChartData = {
      ...
      datasets: [
        { label: 'This year', data: [9, 6, 10, 22, 21, 17, 19], borderColor: '#111827', borderWidth: 3, tension: 0.45, pointRadius: 0 },
        { label: 'Last year', data: [2, 9, 17, 6, 10, 20, 26], borderColor: '#93c5fd', borderWidth: 3, borderDash: [6, 6], tension: 0.45, pointRadius: 0 }
      ]
    };
  }
  loadProjectsChart() {
